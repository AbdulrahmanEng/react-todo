...
test('toggleTodo should not mutate the original todo object', () => {
  const startTodo = {id: 1, name: 'one', isComplete: false};
  const expected = {id: 1, name: 'one', isComplete: true};
...
test('filterTodos should return only incomplete items from the active route', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: true},
    {id: 3, name: 'three', isComplete: false}
...
test('filterTodos should return only completed items from the complete route', () => {
  const startTodos = [
    {id: 1, name: 'one', isComplete: false},
    {id: 2, name: 'two', isComplete: true},
    {id: 3, name: 'three', isComplete: false}
